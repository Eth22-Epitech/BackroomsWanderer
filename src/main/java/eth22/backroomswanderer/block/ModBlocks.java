...
import eth22.backroomswanderer.block.custom.level_0.Level0LightBlock;
...
public class ModBlocks {
    ...
    public static final Block LEVEL_0_LIGHT = registerBlock("level_0_light", new Level0LightBlock(AbstractBlock.Settings.copy(Blocks.REDSTONE_LAMP)));
